...
--
-- Host: localhost
-- Generation Time: Jan 04, 2021 at 12:00 PM
...
--
-- Database: `hybrid_feature`
--
CREATE DATABASE IF NOT EXISTS `hybrid_feature` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `hybrid_feature`;
...
--
-- Table structure for table `remote_user_hybrid_feature_model`
--

CREATE TABLE IF NOT EXISTS `remote_user_hybrid_feature_model` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `names` varchar(300) NOT NULL,
  `creator` varchar(300) NOT NULL,
  `tweet_desc` varchar(300) NOT NULL,
  `tweet_loc` varchar(300) NOT NULL,
  `tweet_date` varchar(300) NOT NULL,
  `retweet` varchar(300) NOT NULL,
  `retweet_date` varchar(300) NOT NULL,
  `retweet_loc` varchar(300) NOT NULL,
  `tweet_score` int(10) NOT NULL,
  PRIMARY KEY (`id`)
